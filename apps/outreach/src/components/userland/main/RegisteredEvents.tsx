                ...
                {events.map((event, index) => (
                    ...
                    >
                        ...
                        <div className="absolute top-4 right-4 flex flex-col items-end gap-2">
                            ...
                            <div className={`flex items-center gap-1 px-2 py-0.5 rounded-md text-[8px] font-bold uppercase tracking-wider ${event.registrationMode === 'team'
                                    ? "bg-blue-500/10 text-blue-400 border border-blue-500/20"
                                    : "bg-zinc-800 text-zinc-400 border border-zinc-700"
                                }`}>
                                {event.registrationMode === 'team' ? <Community width="10" height="10" /> : <User width="10" height="10" />}
                        ...
                        <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1 text-[10px] font-bold text-white/40 group-hover:text-white transition-colors">
                                View Details
                                <ArrowRight width="12" height="12" className="group-hover:translate-x-1 transition-transform" />
                            </div>
                        </div>
                    </motion.div>
                ))}
