        ...
        <div className="flex flex-col h-full bg-zinc-950">
            <div className="flex-none bg-zinc-900 border-b border-zinc-800 shrink-0">
                <div className="flex items-center justify-between p-4">
                    <h2 className="text-xl font-inst font-bold text-white truncate pr-4">
                        {teamData.name}
                    </h2>
                    {onClose && (
                        <button
                            onClick={onClose}
                            className="p-2 hover:bg-zinc-800 rounded-md transition-colors shrink-0"
                        >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6 min-h-0">
                    ...
                    <div className="bg-yellow-900/10 border border-yellow-700/30 rounded-lg p-3 flex items-start gap-3">
                        ...
                        <div className="text-sm">
                            ...
                            <p className="text-yellow-200/70 text-xs mt-0.5">
                                Members cannot be added or removed because the team is registered
                                for an event.
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-4 bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
                    ...
                    <div className="min-w-0">
                        <p className="text-[10px] text-zinc-500 uppercase font-semibold tracking-wider mb-1">
                            Team Leader
                        </p>
                ...
                <section>
                    <h3 className="text-sm font-bold text-zinc-300 uppercase tracking-wide mb-3 flex items-center gap-2">
                        <Community className="h-4 w-4" strokeWidth={2} /> Members
                    </h3>
                    ...
                    <div className="space-y-2">
                        {teamData.members && teamData.members.length > 0 ? (
                            ...
                            <p className="text-sm text-zinc-600 py-2 text-center">
                                Your team awaits new members.
                            </p>
                        )}
                    </div>
                </section>
                ...
                {teamData.pending_invites && teamData.pending_invites.length > 0 && (
                    <section>
                        <h3 className="text-sm font-bold text-zinc-300 uppercase tracking-wide mb-3 flex items-center gap-2">
                            <MessageAlert className="h-4 w-4" strokeWidth={2} /> Pending Invitations
                        </h3>
                        <div className="space-y-2">
            ...
            <div className="flex-none p-4 border-t border-zinc-800 bg-zinc-900 shrink-0 z-10 relative">
              ...
              ${hasRegisteredEvents
                    ...
                    >
                        <UserPlus className="h-4 w-4" strokeWidth={2} /> Add Member
                    </button>
              ...
              ${hasRegisteredEvents
                    ...
                    >
                        <Trash className="h-4 w-4" strokeWidth={2} /> Delete Team
                    </button>
                </div>
            </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl max-w-sm w-full p-6">
                        <div className="flex items-center gap-3 mb-4">
                            <MessageAlert className="h-6 w-6 text-red-500" strokeWidth={2} />
