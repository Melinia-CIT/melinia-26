                    ...
                    {step === "confirm" && (
                        ...
                        >
                            ...
                            <p className="text-sm text-zinc-400 mb-6 leading-relaxed">
                                ...
                                <span className="text-white font-medium">{eventName}</span>. This
                            ...
                            <div className="flex gap-2 sm:gap-3">
                                <button
                                    onClick={onClose}
                                    disabled={loading}
                                    className="flex-1 py-2.5 sm:py-3 px-4 bg-zinc-100 text-zinc-900 font-medium sm:font-semibold hover:bg-white rounded-xl transition disabled:opacity-50 text-sm sm:text-base"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleUnregisterExecute}
                                    disabled={loading}
