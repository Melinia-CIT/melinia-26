...
export default function Sponsors() {
    return (
        <section className="relative w-full py-16 md:py-24 lg:py-32 overflow-hidden bg-zinc-950">
            ...
            >
                <div className="flex flex-col items-center">
                    ...
                    <div className="h-2 w-28 bg-gradient-to-r from-[#FF0066] to-[#FF69B4] mx-auto mt-4 rotate-[2deg] shadow-[0_0_15px_rgba(255,0,102,0.8)]" />
