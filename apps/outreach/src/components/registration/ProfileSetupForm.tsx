			...
			<div className="grid grid-cols-2 gap-4">
				...
				<div>
					...
					<input
						...
						disabled={isLoading}
						{...register("firstName")}
						className={`w-full px-3 py-1.5 rounded-md bg-zinc-800 text-zinc-100 placeholder-zinc-500 border transition focus:outline-none text-sm ${formErrors.firstName
				...
				<div>
					...
					<input
						...
						disabled={isLoading}
						{...register("lastName")}
						className={`w-full px-3 py-1.5 rounded-md bg-zinc-800 text-zinc-100 placeholder-zinc-500 border transition focus:outline-none text-sm ${formErrors.lastName
								? "border-red-500 focus:border-red-500"
								: "border-zinc-700 focus:border-zinc-500"
							} ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
					/>
				...
				<div className="col-span-2">
					...
					<input
						...
						disabled={isLoading}
						{...register("college")}
						className={`w-full px-3 py-1.5 rounded-md bg-zinc-800 text-zinc-100 placeholder-zinc-500 border transition focus:outline-none text-sm ${formErrors.college
								? "border-red-500 focus:border-red-500"
								: "border-zinc-700 focus:border-zinc-500"
							} ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
					/>
				...
				<div>
					...
					<select
						disabled={isLoading}
						{...register("degree")}
						className={`w-full px-3 py-1.5 rounded-md bg-zinc-800 text-zinc-100 border transition focus:outline-none text-sm ${formErrors.degree
								? "border-red-500 focus:border-red-500"
								: "border-zinc-700 focus:border-zinc-500"
							} ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
					>
				...
				<div>
					...
					<select
						...
						className={`w-full px-3 py-1.5 rounded-md bg-zinc-800 text-zinc-100 border transition focus:outline-none text-sm ${formErrors.year
								? "border-red-500 focus:border-red-500"
								: "border-zinc-700 focus:border-zinc-500"
							} ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
					>
				...
				{degree && degree.toLowerCase() === "other" && (
					<div className="col-span-2">
						...
						<input
							...
							className={`w-full px-3 py-1.5 rounded-md bg-zinc-800 text-zinc-100 placeholder-zinc-500 border transition focus:outline-none text-sm ${formErrors.otherDegree
									? "border-red-500 focus:border-red-500"
									: "border-zinc-700 focus:border-zinc-500"
								} ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
						/>
				...
				<div className="col-span-2">
					...
					<input
						...
						maxLength={10}
						{...register("ph_no")}
						className={`w-full px-3 py-1.5 rounded-md bg-zinc-800 text-zinc-100 placeholder-zinc-500 border transition focus:outline-none text-sm ${formErrors.ph_no
								? "border-red-500 focus:border-red-500"
								: "border-zinc-700 focus:border-zinc-500"
							} ${isLoading ? "opacity-50 cursor-not-allowed" : ""}`}
						onInput={(e) => {
