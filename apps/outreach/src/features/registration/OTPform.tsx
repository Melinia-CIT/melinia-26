    ...
    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-4 py-2 rounded bg-zinc-800 text-zinc-100 placeholder-zinc-500 border transition focus:outline-none tracking-widest text-center text-2xl ${
            formErrors.otp
