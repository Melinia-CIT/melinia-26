            ...
            >
                ...
                <AnimatePresence mode="wait">
                    ...
                    {step === "error" && (
                        ...
                        >
                            <div className="w-16 h-16 bg-zinc-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    {step === "Payment required" && (
                        ...
                        >
                            ...
                            <p className="text-sm text-zinc-400 mb-6 px-2">
                                You need to complete your Melinia registration payment before
                    ...
                    {step === "no_teams" && (
                        ...
                        >
                            ...
                            <p className="text-sm text-zinc-400 mb-6">
                                This is a team event. You must create a team in the teams section
                                first.
                            </p>
                            <button
                            ...
                            <div className="space-y-3 max-h-60 overflow-y-auto pr-2 mb-6 custom-scrollbar">
                                ...
                                {teams.map(t => {
                                    ...
                                    return (
                                        <label
                                            key={t.id}
                                            className={`flex items-center justify-between p-4 rounded-xl border transition-all ${isValidSize ? (isSelected ? "border-zinc-500 bg-zinc-500/5" : "bg-white/5 border-white/10 cursor-pointer hover:border-zinc-500/50") : "bg-zinc-950 border-white/5 opacity-50 grayscale cursor-not-allowed"}`}
                                        >
                                            <div className="flex items-center gap-3">
                                                <input
                                                    type="radio"
                    ...
                    {step === "confirm" && (
                        <motion.div
                            ...
                            className="text-center py-4"
                        >
                            <div className="w-16 h-16 bg-amber-500/10 rounded-full flex items-center justify-center mx-auto mb-4 text-amber-500 font-bold text-2xl">
                                !
                            </div>
