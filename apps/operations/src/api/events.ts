...
export type { AssignRoundResults, BulkOperationResult, RoundResult, UserResultError, TeamResultError, RoundResultWithParticipant, PaginatedRoundResults, GetRoundResultsQuery };
