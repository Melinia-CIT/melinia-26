...
export function QRScanner({ onScan, onClose }: QRScannerProps) {
    ...
    useEffect(() => {
        ...
        const startScanner = async () => {
            try {
                ...
                // Request rear camera directly via constraints.
                // This works even before permission is granted and on scrcpy/mirrored devices.
    ...
    return createPortal(
        <div
            className="fixed inset-0 bg-black/90 z-[9999] flex items-center justify-center p-4 min-h-[100dvh]"
            style={{ height: "100dvh" }}
        >
