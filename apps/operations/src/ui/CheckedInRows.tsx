            ...
            >
                ...
                <td className="px-6 py-4">
                    <div className="flex items-center gap-4">
                        {!showTeamColumn && (
                            <div className="flex flex-col items-center justify-center space-y-1.5 min-w-[70px]">
                                ...
                                {isLastRound && assignedPlace ? (
                                    <span
                                        className={`text-[10px] font-black uppercase tracking-widest ${PLACE_ICONS[assignedPlace].cls} border px-1.5 py-0.5`}
                                    >
                                        {PLACE_ICONS[assignedPlace].label}{" "}
                                        {PLACE_LABELS[assignedPlace]}
                                    </span>
                                ) : (
                        ...
                        {!showTeamColumn && <div className="h-8 w-px bg-neutral-800/40" />}
                    ...
                    {showTeamColumn && mIdx === 0 && (
                        ...
                        >
                            <div className="flex flex-col items-center justify-center space-y-2 sticky top-4 text-center">
                                ...
                                {isLastRound && assignedPlace ? (
                                    <span
                                        className={`text-[10px] font-black uppercase tracking-widest ${PLACE_ICONS[assignedPlace].cls} border px-1.5 py-0.5 mt-1`}
                                    >
                                        {PLACE_ICONS[assignedPlace].label}{" "}
                                        {PLACE_LABELS[assignedPlace]}
                                    </span>
...
export function CheckedInCard({
    ...
    const header = (
        <div className="flex items-center gap-3">
            ...
            {isLastRound && assignedPlace && (
                <span
                    className={`shrink-0 text-[10px] font-black border px-1.5 py-0.5 ${PLACE_ICONS[assignedPlace].cls}`}
                >
                    {PLACE_ICONS[assignedPlace].label}
                </span>
            )}
